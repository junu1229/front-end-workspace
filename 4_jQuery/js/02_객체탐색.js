...
// 클래스 선택자 : test 를 선택해서 짝수 인덱스 요소만
...
// .wrap인 요소의 자식의 자식요소들에 style2를 적용
$('.wrap').children().children().css(style2);
// .wrap인 요소의 자식의 자식요소 중 ul태그에 style3를 적용
$('.wrap').children().children('ul').css(style3);
// .wrap인 요소의 자식의 자식의 자식 요소 중에 li태그에 style4를 적용
...
// h2 요소의 형제 다음 형제 요소에 style1 적용
$('.wrap2 h2').next().css(style1);
// h2 요소의 형제 다음 모든 형제 요소에 배경색을 pink
...
// h2 요소의 형제 이전 형제 요소에 style5 적용
$('.wrap2 h2').prev().css(style5);
// h2 요소의 형제 이전 모든 형제 요소에 배경색을 moccasin
